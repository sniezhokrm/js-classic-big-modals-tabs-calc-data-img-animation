...
const drop = () => {
  ...
  fileInputs.forEach(input => {
    input.addEventListener('drop', e => {
      ...
      console.log(input);
      (0,_services_request__WEBPACK_IMPORTED_MODULE_0__.postData)('assets/server.php', input.files).then(res => {
        console.log(res);
...
const forms = () => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      (0,_services_request__WEBPACK_IMPORTED_MODULE_1__.postData)(api, formData).then(res => {
        console.log(res);
...
const modals = state => {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector, destroy = false) {
    ...
    trigger.forEach(item => {
      item.addEventListener("click", e => {
        ...
        document.body.style.marginRight = `${scroll}px`; //document.body.classList.add("modal-open");  - open modal change class name;
      });
    }); //  }
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', () => {
      let scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // check and support for old browsers
...
const pictureSize = imgSelector => {
  ...
  function showImg(block) {
    let img = block.querySelector('img'); // something.png => something-1.png
  ...
  function hideImg(block) {
    let img = block.querySelector('img'); // something-1.png => something.png
...
const showMoreStyles = (trigger, wrapper) => {
  ...
  btn.addEventListener('click', function () {
    ...
    (0,_services_request__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/styles').then(res => showMoreCards(res)).catch(err => errorMassage(err));
...
const slides = (slides, next, prev, dir) => {
  ...
  try {
    // excludes mistake when arrows disabled
  ...
  function activateAnimation() {
    // verical switch slides with interval
    if (dir == 'vertical') {
      paused = setInterval(() => {
        showPlus(1);
...
/* harmony import */ var _modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_slides__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '.main-next-btn', '.main-prev-btn');
  (0,_modules_slides__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', '', '', 'vertical');
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_mask__WEBPACK_IMPORTED_MODULE_4__["default"])('[name = "phone"]');
  (0,_modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_3__["default"])('[name = "name"]');
  (0,_modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_3__["default"])('[name = "message"]');
